...
import { idlFactory } from './vetkd_system_api.did.js';
export { idlFactory } from './vetkd_system_api.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VETKD_SYSTEM_API_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vetkd_system_api.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vetkd_system_api canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vetkd_system_api.did.js")._SERVICE>}
 */
