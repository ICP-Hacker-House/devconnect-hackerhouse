...
import { idlFactory } from './encrypted_notes_rust.did.js';
export { idlFactory } from './encrypted_notes_rust.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ENCRYPTED_NOTES_RUST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./encrypted_notes_rust.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the encrypted_notes_rust canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./encrypted_notes_rust.did.js")._SERVICE>}
 */
export const encrypted_notes_rust = createActor(canisterId);
